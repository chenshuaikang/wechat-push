...
public class LunarSolarConverterUtil {
    ...
    private static SolarCalendarBean SolarFromInt(long g) {
        ...
        SolarCalendarBean solarCalendar = new SolarCalendarBean();
        solarCalendar.setSolarYear((int) y);
        solarCalendar.setSolarMonth((int) mm);
        solarCalendar.setSolarDay((int) dd);
     ...
     * @Date: 2022/9/11
     */
    public static SolarCalendarBean LunarToSolar(LunarCalendarBean lunar) {
     ...
     * @Date: 2022/9/11
     */
    public static LunarCalendarBean SolarToLunar(SolarCalendarBean solar) {
        LunarCalendarBean lunar = new LunarCalendarBean();
